...
## State Codes List ##
State_codes <- read.csv('/Users/tuckerwilke/Desktop/Typologies/State abbreviations.csv')

## Pre Existing State Variables##
State_vars <- read.csv("/Users/tuckerwilke/Desktop/Typologies/state_vars.csv") %>%
  distinct(State, .keep_all = TRUE)

##State Populations##
state_pop <- read_csv("/Users/tuckerwilke/Desktop/Typologies/State Population.csv")
...
Squire <- read_excel("/Users/tuckerwilke/Desktop/Typologies/State Leg Professionalization.xlsx") %>%
  select(c(1,11,16)) %>%
  rename(State=1)
...
climate_opinion_data <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Yale Climate Opinion.csv") %>%
...
State_Vars_Expanded <- State_Vars_Expanded %>%
  left_join(climate_opinion_data, by = "full")
  

#State Gov Payroll and Employment Data##
state_gov_payroll <- read.csv("/Users/tuckerwilke/Desktop/Typologies/2023 State Gov Payroll .csv")
...
## Gini Coefficient##
Gini_Coefficeint_Raw <- read.csv("/Users/tuckerwilke/Desktop/Typologies/Gini Coefficient .csv") %>%
  rename(full = 1) %>%
  rename(Gini = 2)
...
USEER <- read.csv("/Users/tuckerwilke/Desktop/Typologies/USEER Employment Data.csv")
...
US_Reps_FF_Donations <- read_csv("//Users/tuckerwilke/Desktop/Typologies/Money from Oil & Gas to US Representatives, 2023-2024.csv")
US_Reps_Candiates_FF_Donations <- read_csv("//Users/tuckerwilke/Desktop/Typologies/Money from Oil & Gas to US House candidates, 2023-2024.csv")
US_Senators_FF_Donations <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Money from Oil & Gas to US Senators, 2023-2024.csv")
US_Senators_Candiates_FF_Donations <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Money from Oil & Gas to US Senate candidates, 2023-2024.csv")
...
State_Tax_Revenues_2023 <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Tax Sources.csv") %>%
  rename(Tax_Type =1) %>%
...
##Unionization Rates##
Unionization_Rates <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Unionization Rates - Sheet1.csv") %>%
  rename(full = 1) %>%
...
Energy_Production_Trillion <- read_csv("/Users/tuckerwilke/Desktop/Typologies/EIA Energy Data - Production Trillion 2021 BTU.csv")
Energy_Consumption_Billion <- read_csv("/Users/tuckerwilke/Desktop/Typologies/EIA Energy Data - Consumption Billion BTU 2021 .csv")
...
Employment_By_Sector <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Employment By  Sector.csv")%>%
  filter(!is.na(Jobs))
...
##Unemployment Data##
Unemployment <- read_csv("/Users/tuckerwilke/Desktop/Typologies/State Unemployment - Sheet1.csv") %>%
  rename(full=1)
...
##Income Per Capita##
Income_Per_Capita <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Income Per Capita BEA.xlsx - Table.csv") %>%
  rename(full =1)
...
##GDP##
GDP <- read_csv("/Users/tuckerwilke/Desktop/Typologies/GDP_Milions.csv") %>%
  rename(full =1 ) %>%
...
Manufacturing_GDP <- read_csv("/Users/tuckerwilke/Desktop/Typologies/Manufacturing Share of Output - Sheet1.csv") %>%
...
##Typologies##
Typologies<- read_csv("/Users/tuckerwilke/Desktop/Typologies/Typologies - Sheet1.csv")

State_Vars_Expanded <- State_Vars_Expanded %>%
  left_join(Typologies, by = c("State", "full")) 
